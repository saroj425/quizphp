...
<div class="row">
<div class="col-lg-6">
<span class="logo">IT Recruitment</span></div>
...
<a href="#" target="_blank"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;About</a>
</div>
<div class="col-md-3 box">
...
<div class="col-md-3 box">
<a href="javascript.void(0)" target="_blank"><i class="fa fa-github" aria-hidden="true"></i> GitHub</a></div></div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-8">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook"><i class="fa fa-user"></i>&nbsp;Vinit Shahdeo</a>
